...
namespace BooksAPI.Controllers
{
    ...
    public class BooksController : ApiController
    {
        ...
        [HttpPut]
        [Route("")]
        public IQueryable<BookDto> PutBook()
        {
            return Ok();
        }
        ...
        [Route("{id:int}")]
        [ResponseType(typeof(BookDto))]
        public async Task<IHttpActionResult> PutBook(int id)
        {
            BookDto book = await db.Books.Include(b => b.Author)
                .Where(b => b.BookId == id)
                .Select(AsBookDto)
        ...
        [HttpPost]
        [Route("")]
        public IQueryable<BookDto> PostBook()
        {
            find();
            save();
            return Ok();
        ...
        [HttpPost]
        [Route("")]
        public IQueryable<BookDto> PostBook2()
        {
            save();
            return Ok();
        }
        ...
        [Route("{id:int}")]
        [ResponseType(typeof(BookDto))]
        public async Task<IHttpActionResult> PostBook(int id)
        {
            BookDto book = await db.Books.Include(b => b.Author)
                .Where(b => b.BookId == id)
                .Select(AsBookDto)
